    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Sistema de organização de horários para coordenadores pedagógicos
        </p>
      </div>
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link to="/cadastro/professores" className="btn-primary text-center">
            <Users className="h-4 w-4 mx-auto mb-2" />
            Cadastrar Professores
          </Link>
          
          <Link to="/cadastro/materias" className="btn-primary text-center">
            <BookOpen className="h-4 w-4 mx-auto mb-2" />
            Cadastrar Matérias
          </Link>
          
          <Link to="/cadastro/turmas" className="btn-primary text-center">
            <School className="h-4 w-4 mx-auto mb-2" />
            Cadastrar Turmas
          </Link>
        </div>
      </div>
      ...
      <div className="card">
        ...
        {hasMinimalData ? (
          <div className="space-y-4">
            ...
            <Link to="/gerar-horario" className="btn-primary inline-flex items-center space-x-2">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <p className="text-yellow-700 font-medium">⚠️ Dados insuficientes</p>
      ...
      <div className="card bg-gray-50">
        <h2 className="text-lg font-semibold mb-4 text-gray-700">Status do Sistema</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            <p className="font-medium text-gray-700">Armazenamento:</p>
          ...
          <div>
            <p className="font-medium text-gray-700">Modo:</p>
